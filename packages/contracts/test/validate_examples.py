...
运行（仓库根目录）：
  nix shell --impure --expr 'with import (builtins.getFlake "nixpkgs") { system = "x86_64-linux"; }; python3.withPackages (ps: [ ps.jsonschema ps.referencing ])' -c python3 packages/contracts/test/validate_examples.py
"""
import json
import glob
import sys
...
ROOT = "packages/contracts/schemas"
