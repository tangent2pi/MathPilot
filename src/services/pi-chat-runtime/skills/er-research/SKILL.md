...
3. Derive discriminable learner errors and rules linked to the frozen K/T dimensions. Keep uncertainty and citations explicit; do not invent citations.
4. Write `output/er-result.json` using `assets/result-template.json`, then run:
