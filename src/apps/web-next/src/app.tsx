...
const router = createBrowserRouter([
  ...
  { path: "/teacher/students/:studentHandle/memories", element: <TeacherStudentPage kind="memory" /> },
      { path: "/teacher/students/:studentHandle/review", element: <TeacherStudentPage kind="review" /> },
      { path: "/teacher/students/:studentHandle/reviews", element: <TeacherStudentPage kind="review" /> },
